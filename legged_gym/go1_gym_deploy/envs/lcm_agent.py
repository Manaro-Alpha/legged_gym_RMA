...
class LCMAgent():
    def __init__(self, cfg, se:StateEstimator, command_profile):
        ...
        self.last_contact_state = np.zeros(4)
        self.rp = np.zeros(2)
    ...
    def get_obs(self):
        ...
        self.contact_filt = np.logical_or(self.contact_state,self.last_contact_state)
        self.last_contact_state = self.contact_state
